...
#CURRENT MONTH
  ...
  PEDEMIS AS (SELECT ID_PEDIDO,PEDDTEMIS,PEDID.CLICODIGO FROM PEDID INNER JOIN FIS ON PEDID.FISCODIGO1=FIS.FISCODIGO
  ...
  SELECT PD.ID_PEDIDO,PEDDTEMIS,CLICODIGO,PROCODIGO,PDPDESCRICAO,SUM(PDPUNITLIQUIDO*PDPQTDADE)VRVENDA 
   FROM PDPRD PD
